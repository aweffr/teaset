  ...
  renderPage() {
    return (
      <ScrollView style={{flex: 1}}>
        ...
        <ListRow title='Theme' detail='主题' onPress={() => this.navigator.push({view: <ThemeExample/>})}
                 topSeparator='full'/>
        ...
        <ListRow title='NavigationBar' detail='导航栏'
        ...
        <ListRow title='SegmentedBar' detail='分段工具条'
                 onPress={() => this.navigator.push({view: <SegmentedBarExample/>})}/>
        <ListRow title='SegmentedView' detail='分段器'
        ...
        <ListRow title='TransformView' detail='可变视图'
        ...
        <ListRow title='ActionPopover' detail='操作气泡'
        ...
        <ListRow title='PopoverPicker' detail='气泡选择器'
        ...
        <ListRow title='ModalIndicator' detail='模态指示器'
                 onPress={() => this.navigator.push({view: <ModalIndicatorExample/>})} bottomSeparator='full'/>
